...
Customer analysis showed that **Customer 14646** was the highest-spending customer, with total purchases of **£279,489.02**. **459 customers** placed more than 10 orders, with **Customer 14911** placing the highest number of orders at **248**. Monthly analysis showed that **November 2011** was the highest-performing month, generating **£1,126,815.07** in sales.
